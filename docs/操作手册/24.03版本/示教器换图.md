...
A: PNG格式，例如StartImage.png、 SoftwareUpdatingBackground.png。
...
A: 使用T30示教器进行更换时，需将要更换的内容压缩在一个.zip压缩包内，如 background.zip。使用PC版进行更换时，只需将需要更换的文件，复制到程序安装目录下的change/img文件夹下即可。
