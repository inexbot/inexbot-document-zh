...
![](./assets/znr9kxndnmy4inedtaeig.png) 

GETS动作的参数如下图所示：

![](./assets/7qp0k3vnkxerxsbz1tkyy.png) 

PUTS动作下各Location位置的机械手状态如下图所示：

![](./assets/jzjezr0gmygapgn57ztza.png) 

PUTS动作的参数如下图所示：

![](./assets/-9ioruft-w6uw4tgkvdmy.png) 
...
![](./assets/arjm8-mixtwts9sv6f9ww.png) 
...
![](./assets/wa6ivv02ddpwzwa0sweo1.png) 
...
![](./assets/jxjopbrvjxvrukadamy1c.png) 
...
![](./assets/fwof6neussdicdub1nh7n.png) 
...
![](./assets/c-i41jtqwn05q2fulivz4.png) 

## 二、取放片逻辑介绍

### 1.**GETS动作**

![](./assets/g7en_bgexosqsa9uscvvs.png) 
...
![](./assets/lkzflcmyxh7wavj-oha7b.png) 
...
![](./assets/nmesaluwidwwacvzvanaw.png) 
...
![](./assets/9idsgsaupr0l-fvx-6r4l.png) 

| 图片 | 功能说明 |
|------|----------|
| ![](./assets/wezh8-oai93isjcbt_zd6.png)  | 点击【伺服】，切换伺服状态（停止、就绪） |
| ![](./assets/zvrjo7ifpo9t6owdqo2wt.png)  | - |
| ![](./assets/1w5bsqquh54jna5si5uf0.png)  | - |
| ![](./assets/cvxbds5zo7tezifvo7sji.png)  | 点击【机器人】，切换当前机器人（仅多机模式可用） |
| ![](./assets/w6lddmj7ldtwahtkwensf.png)  | 点击【外部轴】，在连接外部轴时切换外部轴和机器人（仅在有外部轴时可用）<br>![](./assets/58supy79ggonzbwo_cs05.png) <br>外部轴：选择外部轴可以点动当前连接的外部轴<br>机器人：选择机器人可以对当前机器人进行点动<br>![](./assets/jiauvsakvkqqdlzyyoh2b.png)  |
| ![](./assets/p2kkavqzjmf3h_w8bdkzm.png)  | 点击【零点】，机器人回到零点位置 |
| ![](./assets/vm8fcne5fv-vcv4frzlhs.png)  | 点击【复位】，机器人运行到记录的复位点位置 |
| ![](./assets/ray0ksackgrtht8pfglbh.png)  | 点击【清错】，机器人在出现错误提示时可清除错误提示 |
| ![](./assets/vr0n_cjain4nsv7w76ycl.png)  | 点击【⭕】，机器人进入拖拽模式，可拖拽机器人到目标点位<br>注意：机器人只有在辨识成功后才能拖拽 |
| ![](./assets/_7jhuchaba5j1axwwd6gc.png)  | 点击【F/B】，在单步运行程序时选择正序或倒序<br>正序运行：指令由上向下运行<br>![](./assets/fciuufkgby7zsbbfcmeui.png) <br>倒序运行：指令由下向上运行<br>![](./assets/ihqlqi7kuoycapsmfnypo.png)  |
| ![](./assets/uthbiefnpvdzsi3k0h4fx.png)  | 点击【单步】，在示教模式下运行程序<br>点击一次运行第一行，完成后点击继续运行下一行，依次执行直到作业文件结束<br>![](./assets/rc9m3btclqhcainvlo_4b.png)  |
| ![](./assets/hwhstlvharzindzaycpae.png)  | 【V-】减小全局速度，每点击一次减小 5%<br>![](./assets/qjamcfn_1ijjos-zpmpcq.png)  |

| ![](./assets/gpml52btshwlvjihqkopj.png){width="0.54375in"              | 【V+】增加全局速度，每点击一次全局速度增加5%                                                                                                                                   |
| height="0.5346872265966754in"}                                              |                                                                                                                                                                                |
|                                                                             | ![](./assets/n2dzougb_k_adggziftsi.png)                                                                      |
| 图片 | 功能说明 |
|------|----------|
| ![](./assets/rjnumxv_n0exy-ahhtud4.png)  | 【工具】切换工具手 |
| ![](./assets/tabradfuvy3-xc-hkqape.png)  | - |
| ![](./assets/vhscv8ls5tk8w4xo51h8h.png)  | 【坐标】切换坐标、点击坐标按钮可以依次切换关节坐标、直角坐标、工具坐标和用户坐标 |
| ![](./assets/d89xbvzrl4zngm3mjs6f_.png)  | - |
| ![](./assets/zinrmjrsiy3pplxzv4enc.png)  | 【切换操作模式】旋钮在左边表示示教模式、中间表示运行模式、右边表示远程模式 |
| ![](./assets/joktcsnfnoflj9bmnal_-.png)  | 【紧急停止按钮】程序运行时出现碰撞或飞车等情况按下急停按钮，机器人会停止运动 |
| ![](./assets/1xybfhfpr1qtpewxchrc1.png){width="7.298993875765529e-2in" | 【启动】在运行模式下用来启动程序，点击【启动】程序开始运行                                                                                                                     |
| height="6.89359142607174e-2in"}                                             |                                                                                                                                                                                |
| 图片 | 功能说明 |
|------|----------|
| ![](./assets/fzpq-8fpjdkedwesib4da.png)  | 【停止】在运行模式下用来暂停程序，点击【停止】正在运行的程序会暂停运行 |
| ![](./assets/d5bspqmlk3h7slby1fsco.png)  | 【-】示教时对应轴负方向运行 |
| ![](./assets/eeiciy_w-p94ln_y2vhmv.png)  | 【+】示教时对应轴正方向运行 |
| ![](./assets/iria6eo35xs4dfpd0yxgf.png)  | 程序界面旋转切换上一行、下一行 |
| ![](./assets/sld6nrtlzxhx-wni3ydak.png)  | 示教器握把后面的按钮，按到中间控制机器人（伺服）上电、按到底控制机器人（伺服）下电、松开按键控制机器人（伺服）下电 |

### 2.监控界面参数说明

![](./assets/wekichrji5zliv0toxhdx.png) 

【快捷键】

![](./assets/4igmvelopaxmi4xn6xoco.png) 
...
![](./assets/9aikapqkdowkimapcvnn1.png) 
...
![](./assets/ftoolxtdi32cx2jnj_j1h.png) 
...
![](./assets/tbmi0xalczje6e8kqvjpg.png) 

【轴速度】

机器人在移动时根据设置的指令速度和全局速度参数，在监控-轴速度界面可以监控机器人运行时的当前速度和最大速度，如图：

![](./assets/jrfqpuerdn1qeztr3lkm5.png) 

![](./assets/ydoowbm2jpy2t27c1qmz6.png) 

### 3.状态栏介绍

![](./assets/tvpzd5omwyrekgzrkdz8u.png) 
...
| 速度状态 | 内容 |
|----------|------|
| 速度状态 | 1. 点动<br><br>速度范围：[1%,100%]<br><br>按下示教器底部的【V+】，【V-】速度每次增加或者减小5%<br><br>点击下图所示的【+】，【-】速度每次增加或者减小1%<br><br>![](./assets/toz44dnd0ayp3pg_2v8x2.png) |
...
![](./assets/opl_9i3svxahtvc0svxdr.png) 

> 2：首先检查伺服【就绪状态】，需要切换伺服状态为"就绪"。

![](./assets/cmszsnaba-inktzval4at.png) 

> 3：确认速度，建议先用5%速度，低速确认安全，慢慢调整合适速度。
>
> 4：按下上电按钮。

![](./assets/wo_gxpfqrk_8b5tp9vhio.png) 
...
![](./assets/bbl0dooq-kgin2gcqqqbx.png) 
...
![](./assets/h1snihsysrsaif2wvqzi-.png) 
...
![](./assets/6r1notnkauqrwnt5diwyb.png) 
...
![](./assets/wrympjfesiff-hublbmef.png) 

![](./assets/7ubdyv3pdmzu3a5udd94g.png) 

## 附录五、取放片层高避障

如图，若某个工位最高层为5层，那么使用1、2片叉去第四层时能正常取放片，但是使用1、2片叉同时去第五层就会超过最大层高，系统会自动计算并报错停止。

![](./assets/jfah7geyqmjm1dhx8ylun.png) 
