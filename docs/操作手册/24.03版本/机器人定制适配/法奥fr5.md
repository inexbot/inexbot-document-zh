---
title: "法奥fr5末端IO适配"
description: "法奥fr5机器人末端IO适配指南，包括机器人配置、末端连接器、指示灯、拖拽功能和点记录等"
author: "iNexBot"
date: "2026-04-07"
...
### 1.1 文档目的
本文档旨在详细介绍法奥fr5机器人的末端IO适配方案，包括机器人配置、末端连接器说明、指示灯状态、拖拽功能设置和点记录操作等内容，帮助用户正确配置和使用法奥fr5机器人的末端IO功能。

### 1.2 适用范围
适用于法奥fr5机器人的末端IO适配和功能配置。
